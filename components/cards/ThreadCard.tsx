        ...
        <article className={`flex w-full flex-col ${isComment ? 'px-0 xs:px-7' : 'rounded-xl bg-dark-2 p-7'}`}>
            ...
            <div className="flex items-start justify-between">
                ...
                <div className="flex w-full flex-1 flex-row gap-4">
                    {/* container containing post auther's image. */}
                    ...
                    {/* container containing all the contents of the post. */}
                    <div className="flex w-full flex-col">
                        ...
                        {/* container containing buttons such as like, share, repost etc. and replies' details */}
